...
".frm_input('Количество персон#Number of persons',$results, true, 'small')."
 ".frm_date('Дата проведения#Dates',$results, true, 'small')."
...
$contacts_info = getContactsInfo();
    ...
    if($_REQUEST[ok]){ $_RETURN_DATA=L('Ваше сообщение отправлено.','Your message has been sent'); }
    	...
    	global $_PAGE;
    	$_PAGE['retitle']=L('Заявка на проведения свадьбы/банкета','Application for the wedding');
